...
const nftNotOwned = createCustomErrorClass("nftNotOwned");
  ...
  fillTransactionStatus: (a, t, result) => {
    ...
    if (!result.errors.recipient) {
      ...
      if (
        ...
        result.errors.amount = new nftNotOwned();
      }
    }
  },
  /**
   * This is executed during the buildEthereumTx
   */
